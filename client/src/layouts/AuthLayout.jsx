      ...
      {aside && (
        <aside className="auth-aside">
          ...
          <div className="security-preview">
            ...
            <p className="preview-quote">“Private conversations should feel private.”</p>
            <div className="preview-encryption"><span>End-to-end encrypted</span><span className="live-pulse" /></div>
          </div>
